	...
	function qode_generate_import_page() {
									...
									<div class="row">
										<div class="col-lg-3">
											<select name="import_example" id="import_example" class="form-control qodef-form-element">
												...
												<option value="bridgedb91">New Demo 91 - City Listing</option>
												<option value="bridgedb92">New Demo 92 - Music Magazine</option>
												<option value="bridgedb93">New Demo 93 - Restaurant and Bar</option>
												<option value="bridgedb94">New Demo 94 - Business Report</option>
												<option value="bridgedb95">New Demo 95 - Business Conference</option>
												<option value="bridgedb96">New Demo 96 - Global Business</option>
												<option value="bridgedb97">New Demo 97 - Financial Business</option>
												<option value="bridgedb98">New Demo 98 - Construction Showcase</option>
												<option value="bridgedb99">New Demo 99 - Attorney</option>
												<option value="bridgedb100">New Demo 100 - Clean Energy</option>
												<option value="bridgedb101">New Demo 101 - Startup Summit</option>
												<option value="bridgedb102"><?php esc_html_e('New Demo 102 - App Launch', 'qode'); ?> </option>
												<option value="bridgedb103"><?php esc_html_e('New Demo 103 - App Presentation', 'qode'); ?> </option>
												<option value="bridgedb104"><?php esc_html_e('New Demo 104 - Winter Sports', 'qode'); ?> </option>
												<option value="bridgedb105"><?php esc_html_e('New Demo 105 - Smoothie Bar', 'qode'); ?> </option>
												<option value="bridgedb106"><?php esc_html_e('New Demo 106 - Yoga Center', 'qode'); ?> </option>
												<option value="bridgedb107"><?php esc_html_e('New Demo 107 - Beer Showcase', 'qode'); ?> </option>
												<option value="bridgedb108"><?php esc_html_e('New Demo 108 - Plumber', 'qode'); ?> </option>
												<option value="bridgedb109"><?php esc_html_e('New Demo 109 - Hair Salon', 'qode'); ?> </option>
												<option value="bridgedb110"><?php esc_html_e('New Demo 110 - Freelancer', 'qode'); ?> </option>
												<option value="bridgedb111"><?php esc_html_e('New Demo 111 - Bakery', 'qode'); ?> </option>
												<option value="bridgedb112"><?php esc_html_e('New Demo 112 - Running Club', 'qode'); ?> </option>
												<option value="bridgedb113"><?php esc_html_e('New Demo 113 - Beauty Center', 'qode'); ?> </option>
												<option value="bridgedb114"><?php esc_html_e('New Demo 114 - SEO Company', 'qode'); ?> </option>
												<option value="bridgedb115"><?php esc_html_e('New Demo 115 - Babysitter', 'qode'); ?> </option>
												<option value="bridgedb116"><?php esc_html_e('New Demo 116 - Wedding Planner', 'qode'); ?> </option>
												<option value="bridgedb117"><?php esc_html_e('New Demo 117 - Florist', 'qode'); ?> </option>
												<option value="bridgedb118"><?php esc_html_e('New Demo 118 - Designer Expo', 'qode'); ?> </option>
												<option value="bridgedb119"><?php esc_html_e('New Demo 119 - Music Festival', 'qode'); ?> </option>
												<option value="bridgedb120"><?php esc_html_e('New Demo 120 - Moving Company', 'qode'); ?> </option>
												<option value="bridgedb121"><?php esc_html_e('New Demo 121 - Burger Place', 'qode'); ?> </option>
												<option value="bridgedb122"><?php esc_html_e('New Demo 122 - Urban Dance', 'qode'); ?> </option>
												<option value="bridgedb123"><?php esc_html_e('New Demo 123 - Vineyard', 'qode'); ?> </option>
											</select>
										</div>
									</div>
		...
		<script type="text/javascript">
            var showExample = function(){
                var optionSelected = $j("#import_example option:selected").val();
                $j('#demo_site_img').attr('src', 'http://export.qodethemes.com/bridge-admin/images/demos/' + optionSelected + '.jpg' );
                $j('#qode-required-plugins').fadeOut(100);
                jQuery.ajax({
                    type: 'POST',
                    url: ajaxurl,
                    dataType: 'html',
                    ...
                    success: function(response){
                        $j('#qode-required-plugins').html(response).fadeIn(100);
                    },
                    error: function(){
                        $j('#qode-required-plugins').empty();
                    }
                });
            }
			...
			$j(document).ready(function() {
                ...
                $j('#qode-required-plugins').on('click', '.qode-demo-plugin-install-link', function (e) {
                    e.preventDefault();
                    var $this = $j(this);
