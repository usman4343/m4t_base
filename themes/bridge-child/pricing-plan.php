	...
	<div class="wrapper" style="background: #F2F2F2;">
        ...
        <div class="pricing-table group first-row">
            ...
            <div class="block professional fl">
                ...
                <!-- FEATURES -->
                <ul class="features">
                    <li><span class="fontawesome-cog"></span>Access Premium Content</li>
                    <li><span class="fontawesome-star"></span>Access Live Online Events</li>
            ...
            <div class="block business fl">
                ...
                <ul class="features">
                    ...
                    <li><span class="fontawesome-star"></span>Access to Premium Content</li>
                    <li><span class="fontawesome-dashboard"></span>Trade Recommendations</li>
		...
		<div class="pricing-table group second-row">
          ...
          <!-- GOLD -->
            <div class="block business fl">
                ...
                <!-- FEATURES -->
                <ul class="features">
                     <li><span class="fontawesome-cog"></span>Includes Silver Subscription</li>
                    <li><span class="fontawesome-star"></span>Trading Recommendations</li>
            ...
            <div class="block personal fl">
                ...
                <!-- FEATURES -->
                <ul class="features">
                    <li><span class="fontawesome-cog"></span>Gold Subscription</li>
                    <li><span class="fontawesome-star"></span>Trade Recomendations</li>
                    <li><span class="fontawesome-dashboard"></span>Crypto Academy</li>
