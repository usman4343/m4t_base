...
<head>
    ...
    <!-- Morris Chart CSS -->
	<link rel="stylesheet" href="<?php echo get_stylesheet_directory_uri(); ?>/Dark/assets/plugins/morris/morris.css">
     <!-- Circlifull chart css -->
    <link href="<?php echo get_stylesheet_directory_uri(); ?>/Dark/assets/plugins/jquery-circliful/css/jquery.circliful.css" rel="stylesheet" type="text/css"/>

     <!-- Custom box (Modal) css -->
        <link href="<?php echo get_stylesheet_directory_uri(); ?>/Dark/assets/plugins/custombox/dist/custombox.min.css" rel="stylesheet">
        <!-- Dragula (Drag and drop) css -->
        <link href="<?php echo get_stylesheet_directory_uri(); ?>/Dark/assets/plugins/dragula/dragula.min.css" rel="stylesheet">

    <!-- App css -->
    <link href="<?php echo get_stylesheet_directory_uri(); ?>/Dark/assets/css/bootstrap.min.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo  get_stylesheet_directory_uri(); ?>/Dark/assets/css/core.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo  get_stylesheet_directory_uri(); ?>/Dark/assets/css/components.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo  get_stylesheet_directory_uri(); ?>/Dark/assets/css/icons.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo  get_stylesheet_directory_uri(); ?>/Dark/assets/css/pages.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo  get_stylesheet_directory_uri(); ?>/Dark/assets/css/menu.css" rel="stylesheet" type="text/css" />
    <link href="<?php echo  get_stylesheet_directory_uri(); ?>/Dark/assets/css/responsive.css" rel="stylesheet" type="text/css" />
    ...
    <script src="<?php echo  get_stylesheet_directory_uri(); ?>/Dark/assets/js/modernizr.min.js"></script>
</head>
                ...
                <div class="sidebar-inner slimscrollleft">
                    ...
                    <div class="user-box">
                        ...
                        <ul class="list-inline">
                            <li>
                                <a href="?page=change-profile.html" >
                        ...
                        <ul>
                            ...
                            <li class="has_sub">
                                ...
                                <ul class="list-unstyled">
                                    <li><a href="https://mining4truth.com/cryptocurrencies/">Cryptocurrencies</a></li>
                                    <li><a href="#">Low</a></li>
