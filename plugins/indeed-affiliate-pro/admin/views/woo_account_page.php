		...
		<div class="inside">
			...
			<div class="row">
				<div class="col-xs-7">
					...
					<p><?php _e('Fully integrate user Affiliate Account with their WooCommerce MyAccount. Once is activated a new Tab into Woo MyAccount menu will show up.', 'uap');?></p>
			...
			<div class="row">
				<div class="col-xs-7">
					...
					<p><?php _e('Even the non-affiliate users will see the new option but instead of Affiliate account page a custom Content will show up.', 'uap');?></p>
