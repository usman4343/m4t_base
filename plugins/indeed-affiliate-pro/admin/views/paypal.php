			...
			<?php if ((float)$phpversion>=5.4):?>	
				...
				<div style="font-size: 11px; color: #333; padding-left: 10px;">
					<ul class="uap-info-list">
						<li><?php _e('1. Go to ', 'uap');?><a href="https://developer.paypal.com/" target="_blank">https://developer.paypal.com/</a> <?php _e('and login with your PayPal E-mail and password.', 'uap');?></li>
						<li><?php _e('2. After You successfully logged go to:', 'uap');?> <a target="_blank" href="https://developer.paypal.com/developer/applications/">https://developer.paypal.com/developer/applications/</a> <?php _e('and create a new REST API application.', 'uap');?></li>
						<li><?php _e('3. After You created a new application the "Client ID" and "Client Secret" will be available.', 'uap');?></li>
					</ul>							
				</div>
