		...
		<div class="row">
		  <div class="col-xs-5">	
			<div class="uap-form-line">
				...
				<p><?php _e('Set a maximum amount that can not be passed for a referral. Is a safety limit decided by the Admin for avoiding big Referrals that have to be paid.', 'uap'); ?></p>
			...
			<div class="uap-inside-item">	
				<div class="row" style="margin-left:0px;">
					<div class="col-xs-5" style="margin-bottom: 10px;">
						...
						<p><?php _e('Set the default Flat Amount  Limit that will be used when no special limit is set for certain Rank', 'uap');?></p>
			...
			<?php if (!empty($data['ranks'])):?>
				...
				<div class="row" style="margin-left:0px;">
					<div class="col-xs-4" style="margin-bottom: 10px;">
						...
						<p><?php _e('Set a special Max Amount Limit for each Rank. This option will become available into Rank Settings page also.', 'uap');?></p>
