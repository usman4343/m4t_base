				...
				<div class="uap-stuffbox">
					...
					<div class="inside">
						...
						<?php if (!empty($data['rank_list'])) :?>
							...
							<p><?php _e('Set a special LifeTime Amount for each Rank that will take in place the Default Amount Rank. This option will become available into Rank Settings page also.', 'uap');?></p>
