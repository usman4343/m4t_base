	...
	<div class="uap-stuffbox">
		...
		<div class="inside">
			<div class="row">
				...
				<p><?php _e('Directly Links without any visible affiliate links listed. Once there is no URLs with references attached, a simple user can not avoid using the link just because is on someone benefits.', 'uap');?></p>
			...
			<div class="uap-inside-item">		
				<div class="row" style="margin-left:0px;">
					<div class="col-xs-4" style="margin-bottom: 10px;">
						...
						<p><?php _e('Decides how many Links can be submitted by one Affiliate into his Account Page.', 'uap');?></p>
	...
	<div class="uap-stuffbox">
		...
		<div class="inside">	
				<div class="row" style="margin-left:0px;">
					...
					<p><?php _e('Attach a Referrer Link to a specific Affiliate user directly from UAP Dashboard.', 'uap');?></p>
						<div class="input-group" style="margin:0px 0 15px 0;">
