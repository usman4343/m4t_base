				...
				<div class="row" style="margin-left:0px;">
					<div style="font-size: 11px; color: #333; padding-left: 10px;">
						<ul class="uap-info-list">
							<li><?php echo __("1. Go to ", 'uap') . '<a href="https://pushover.net/" target="_blank">https://pushover.net/</a>' . __(" login with Your credentials or SignUp for a new account.", 'uap');?></li>
