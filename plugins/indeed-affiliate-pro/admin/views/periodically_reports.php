<form action="" method="post">
	<div class="uap-stuffbox">
		...
		<div class="inside">
			...
			<div class="row">
				<div class="col-xs-7">
					<h3><?php _e('Activate/Hold Periodically Reports', 'uap');?></h3>
					<p><?php _e('If this Module is activated, Affiliates will be able to get periodically reports about their Affiliate account and rewards. Each Affiliate may decides the periord of his reports (daily, weekly, monthly) from this Account Page.', 'uap');?></p>
			...
			<div class="row">
				<div class="col-xs-8">
					...
					<p><?php _e('Decide when is the best time of the day for your Website to start managing Email Reports. Everyday, the script is running on the back-end and check the time spent for each Affiliate from the last report and the Report period set by each Affiliate. If is time for sending a new one, the System will manage a new Report for Affiliate.', 'uap');?></p>
					...
					?></select>
					<p style="font-weight:bold;"><?php _e('Keep in mind that it may be necessary to be sent a big number of Emails and your Hosting provider may restrict this action only on certain no of Emails. Be sure that you are able to manage Email Reports for all of your Affiliates..', 'uap');?></p>
				</div>
			</div>				
