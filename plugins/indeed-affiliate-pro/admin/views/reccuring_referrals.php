			<form action="" method="post">
				<div class="uap-stuffbox">
					<h3 class="uap-h3"><?php _e('Reccuring Referrals', 'uap');?></h3>
					<div class="inside">
					<div class="row">
						<div class="col-xs-5">
						...
						<?php if (!empty($data['rank_list'])) :?>
							...
							<p><?php _e('Set a special Recurring Amount for each Rank that will take in place the Default Amount Rank. This option will become available into Rank Settings page also.', 'uap');?></p>
