	...
	<div class="uap-stuffbox">
		...
		<div class="inside">
			...
			<div class="uap-form-line">	
				...
				<p><?php _e('Requires to be verified the email address for new Affiliates before they will be able to Login. If the Email address is not confimed, the user account may be automatically deleted after a certain time', 'uap');?></p>
