		...
		<div class="inside">
			<div class="row">
				<div class="col-xs-8">
					...
					<p><?php _e('Once is activated the Customer will have the option to select an Affiliate for commission during the Checkout process.', 'uap');?></p>
			...
			<div class="row">
				<div class="col-xs-4">
					<div class="uap-form-line">
						...
						<p><?php _e('Choose specific Affiliates to show up into Checkout selection if you do not want to display all of them.', 'uap');?></p>
			...
			<div class="row">
				...
				<h3><?php _e('Additional Settings', 'uap');?></h3>								
					<div class="uap-form-line">
						...
						<p><?php _e('If there is already an Affiliate assigned for current visitor/customer this one can be igonred. If not, the Checkout Option will not show up.', 'uap');?></p>
						<label class="uap_label_shiwtch" style="margin:10px 0 10px -10px;">
