					...
					<div class="uap-inside-item">
						<div class="row">
							...
							<h4><?php _e('Activate/Hold Rank', 'uap');?></h4>
								<p><?php _e('Active or set on Hold a specific Rank without being necessary to delete it', 'uap');?></p>
				...
				<div class="uap-inside-item">
					<div class="row">	
						<div class="col-xs-8">
							...
							<p><?php _e('Based on Rank Position an Affiliate may jump to the next Rank if the Achievement conditions are applied.', 'uap');?></p>	
				...
				<div class="uap-inside-item">
					<div class="row">	
						<div class="col-xs-4">
							...
							<p><?php _e('To jump into current Rank, the Affiliates needs to accomplish the required achievements', 'uap');?></p>	
		...
		<div class="uap-stuffbox uap-magic-stuffbox" style="display: <?php echo  (empty($data['bonus_enabled'])) ? 'none' : 'block'; ?>;">
			...
			<div class="row">
				<div class="col-xs-4">
					...
					<p><?php _e('Affiliate will receive Bonus with a flat Amount each time when will achieve a specific Rank.', 'uap');?></p>	
						<div class="input-group">
		...
		<div class="uap-stuffbox uap-magic-stuffbox" style="display: <?php echo ($data['display-signup_referrals']) ? 'block' : 'none'; ?>;">				
			...
			<div class="row">
				<div class="col-xs-4">
					...
					<p><?php _e('Available for Membership system awarding commission when referred user sign Up', 'uap');?></p>	
						<div class="input-group">
							<span class="input-group-addon" id="basic-addon1">Amount</span>
		...
		<div class="uap-stuffbox uap-magic-stuffbox" style=" display: <?php echo ($data['display-lifetime_commissions']) ? 'block' : 'none'; ?>;">				
			...
			<div class="row">
				<div class="col-xs-4">
					...
					<p><?php _e('Allow for your Affiliate to receive commssion for all lifeTime referrals', 'uap');?></p>	
