		...
		<div class="uap-inside-item">
			<div class="row">
				...
				<h4><?php _e('Activate/Hold Shortcode', 'uap');?></h4>
					<p><?php _e('You can activate or deactivate a Shortcode anytime without delete it.', 'uap');?></p>
		...
		<div class="uap-inside-item">
			<div class="row">	
				<div class="col-xs-6">
					...
					<p><?php _e('Based on the Landing Commission Price, the Referral Amount will be calculate depending of each Affiliate Rank Amount.', 'uap');?></p>	
					 <div class="input-group">
