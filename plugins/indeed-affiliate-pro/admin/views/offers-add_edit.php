		...
		<div class="uap-inside-item">
				<div class="row">
					...
					<h4><?php _e('Activate/Hold Offer', 'uap');?></h4>
						<p><?php _e('You can activate or deactivate an Offer anytime without delete it.', 'uap');?></p>
			...
			<div class="uap-inside-item">
					<div class="row">	
						<div class="col-xs-4">
							...
							<p><?php _e('A special Amount for this specific Offer needs to be set which will take in place the standard Amount Rank', 'uap');?></p>	
				...
				<div class="uap-inside-item">
					<div class="row">	
						<div class="col-xs-4">
							...
							<p><?php _e('The Offer will be active on a certain time interval based on your selling strategy.', 'uap');?></p>
				...
				<div class="uap-inside-item uap-special-line">
					<div class="row">	
						<div class="col-xs-4">
							...
							<p><?php _e('Choose certain Affiliates or Type "All" to provide this Offer for all your affiliates users.', 'uap');?></p>
							<div class="input-group">
