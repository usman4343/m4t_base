...
<?php if (!empty($data['total_paid'])): ?>
		<div class="uapcol-md-3">
			<div class="uap-account-no-box uap-account-box-green">
			  <div class="uap-account-no-box-inside">
				<div class="uap-count"><?php echo round($data['total_paid'], 2) .' '. $data['currency'];?></div><div class="uap-detail"><?php echo __('Total Earnings (paid Refferals)', 'uap'); ?></div>
			  </div>
			</div>
		</div>
<?php endif;?>
<?php if (!empty($data['total_unpaid'])): ?>			
		<div class="uapcol-md-3">
			<div class="uap-account-no-box uap-account-box-red">
			  <div class="uap-account-no-box-inside">
				<div class="uap-count"><?php echo round($data['total_unpaid'], 2) .' '. $data['currency'];?></div><div class="uap-detail"><?php echo __('Your current Balance', 'uap'); ?></div>
			  </div>
			</div>
		</div>
<?php endif;?>	
