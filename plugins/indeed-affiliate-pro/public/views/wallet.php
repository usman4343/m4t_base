...
<div class="uap-row">
	...
	<div class="uapcol-md-2">
		<div class="uap-account-no-box uap-account-box-blue">
			<div class="uap-account-no-box-inside">
				<div class="uap-count"> <?php echo round(@$data['stats']['wallet'], 2) .' '. $data['currency']; ?> </div>
	...
	<div class="uapcol-md-2">
		<div class="uap-account-no-box uap-account-box-green">
			<div class="uap-account-no-box-inside">
				<div class="uap-count"> <?php echo round($data['stats']['unpaid_payments_value'], 2) .' '. $data['currency']; ?> </div>
...
<?php if ($data['items']):?>
	...
	<?php foreach ($data['items'] as $k=>$v):?>
		<tr>
			...
			<td><?php echo $v['amount'] . ' ' . $data['currency'];?></td>
